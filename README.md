...
![Build and deploy status badge](https://github.com/cipscis/throttle-with-debounce/actions/workflows/build-and-deploy.yml/badge.svg)
...
See [Throttle with Debounce documentation](https://cipscis.github.io/throttle-with-debounce/)

## Development

You will need to install [Node.js](https://nodejs.org/en/) before working on this package.

1. Clone the repository using `git clone https://github.com/cipscis/throttle-with-debounce.git`.
